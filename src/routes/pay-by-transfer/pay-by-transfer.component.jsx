      ...
      <div className="grid md:grid-cols-2 gap-8">
        <div>
          <p className="text-sm font-bold italic mb-8">
            Kindly Submit this form if you have made your transfer
          </p>
          <form action="" onSubmit={submitForm}>
            ...
            <div>
              <AppButton children="Submit" buttonType="primary" type="submit" />
            </div>
          </form>
        </div>
        <div>
          <div className="mb-10">
            ...
            <p className="text-sm itallic mb-2">
              <span className="font-bold">Firstbank: </span> *894*Amount*Account
              number#
            </p>
          </div>
          <div>
